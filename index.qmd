...
Analicemos la riqueza léxica em usuarios de reddit
...
textstat_keyness(dfm, target = dfm$subreddit == "argentina") %>% 
  textplot_keyness()
...
Los tópicos no quedaron tan bien formados
...
Cargaremos archivos de un modelo ya entrenado
...
Utiliza los datos de reddit, para construir una visualización de tópicos
